...
function blackgenerateCode() {
    ...
    if (noValue && ncValue) {
        ...
        const resultContainer = document.getElementById('result');
        const imageContainer = document.getElementById('blackimageContainer');
...
function greengenerateCode() {
    ...
    if (noValue && ncValue) {
        ...
        const resultContainer = document.getElementById('result');
        const imageContainer = document.getElementById('greenimageContainer');
...
function redgreengenerateCode() {
    ...
    if (noValue && ncValue) {
        ...
        const resultContainer = document.getElementById('result');
        const imageContainer = document.getElementById('redimageContainer');
...
function bluegreengenerateCode() {
    ...
    if (noValue && ncValue) {
        ...
        const resultContainer = document.getElementById('result');
        const imageContainer = document.getElementById('blueimageContainer');
...
function yellowgenerateCode() {
    ...
    if (noValue && ncValue) {
        ...
        const resultContainer = document.getElementById('result');
        const imageContainer = document.getElementById('yellowimageContainer');
